...
class AdminTable extends Component{
        ...
        render(){
            ...
            let { access_id }= this.props.access_id
            let access = false;
            ...
            if(this.props.access_id == '6288dccb3da6ef408e07cbd1'){
                access = true;
            }else if(access_id == null){
                return(
                    <>
                        <h4>Access denied.</h4>
                    </>
                                ...
                                <MDBTableBody>
                                    {establishments.map((estabs) =>(
                                        ...
                                        >
                                            ...
                                            <td align="center">
                                                <button type="button" className="btn btn-danger me-2 btn-sm" onClick={this.onDeleteClick.bind(this,estabs._id)}>
...
const mapStateToProps = (state) => ({
    ...
    users: state.users,
    access_id: state.authentication.user._id
});
